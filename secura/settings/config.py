...
class FIRDetails(BaseModel):
    ...
    circle_sub_division: Optional[str] = Field(title="Circle/Sub Division",
                                               json_schema_extra={"is_anonymized": True, "section": 1})
    ...
    information_received_at_ps: Optional[str] = Field(title="Information received at the PS",
                                                      json_schema_extra={"is_anonymized": True, "section": 3})
    ...
    information_received_to_date: Optional[str] = Field(title="To Date",
                                                        json_schema_extra={"is_anonymized": True, "section": 3})
    occurrence_of_offence_day: Optional[str] = Field(title="Occurence of Offence Day",
                                                     json_schema_extra={"is_anonymized": True, "section": 3})
    ...
    general_diary_reference_time: Optional[str] = Field(title="General Diary reference Time",
                                                        json_schema_extra={"is_anonymized": True, "section": 3})
    place_of_occurrence_address: Optional[str] = Field(title="Place of occurence with full address",
                                                       json_schema_extra={"is_anonymized": True, "section": 4})
    ...
    complainant_informant_name: Optional[str] = Field(title="Name",
                                                      json_schema_extra={"is_anonymized": True, "section": 5})
    complainant_informant_father_husband_name: Optional[str] = Field(title="Father's/Husband's Name",
                                                                     json_schema_extra={"is_anonymized": True,
                                                                                        "section": 5})
    complainant_informant_age: Optional[int] = Field(title="Age",
                                                     json_schema_extra={"is_anonymized": True, "section": 5})
    ...
    complainant_informant_seen_occurrence: Optional[str] = Field(
        ...
        json_schema_extra={"is_anonymized": True, "section": 5})
    accused_details: Optional[dict] = Field(title="Details of known/suspected/unknown accused with full particulars",
                                            json_schema_extra={"is_anonymized": True, "section": 6})
    victim_details: Optional[dict] = Field(title="Details of Victims with full particulars",
                                           json_schema_extra={"is_anonymized": True, "section": 7})
    stolen_property_details: Optional[dict] = Field(title="Particulars of Property stolen/involved with value",
                                                    json_schema_extra={"is_anonymized": True, "section": 8})
    inquest_report_ud_case_no: Optional[str] = Field(title="Inquest Report/U.D. Case No. if any",
                                                     json_schema_extra={"is_anonymized": True, "section": 9})
    fir_contents: Optional[str] = Field(title="F.I.R Contents",
                                        json_schema_extra={"is_anonymized": True, "section": 10})
    action_taken: Optional[str] = Field(title="Action Taken", json_schema_extra={"is_anonymized": True, "section": 11}),
    signature: str = Field(title="Signature/Thumb impression of the complainant",
                           json_schema_extra={"is_anonymized": True, "section": 12})
    fir_dispatch_date_time: Optional[str] = Field(title="Date and time of dispatch to the Court",
                                                  json_schema_extra={"is_anonymized": True, "section": 13})
    fir_carrier_name: Optional[str] = Field(title="Name of PC/HC who carried the FIR to the Court",
                                            json_schema_extra={"is_anonymized": True, "section": 14})
